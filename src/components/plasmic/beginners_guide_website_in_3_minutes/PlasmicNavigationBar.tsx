...
import sty from "./PlasmicNavigationBar.module.css"; // plasmic-import: 8DTc7jx6rL7C/css
  ...
  return (
    <NavigationBar
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__pCaYe)}
          displayHeight={"auto"}
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___81HcL)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
