...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: rpLtV_HQwdAu/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__c9R1F)}>
        <div className={classNames(projectcss.all, sty.column___4Qj9S)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__r7SCm)}>
          <div className={classNames(projectcss.all, sty.columns__kuPn7)}>
            <div className={classNames(projectcss.all, sty.column__g5Ehk)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__d4Oqa)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column___38VHs)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__tjIjx)}>
                {renderPlasmicSlot({
