...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: ZdLCOTSAwktK/css

import RightArrowIcon from "./icons/PlasmicIcon__RightArrow"; // plasmic-import: juv1y_1NSoNI/icon
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___1BiG)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__swVhs)}>
          <PlasmicLink__
